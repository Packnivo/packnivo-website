          ...
          <div className="prose max-w-none">
            ...
            <div className="space-y-4 mb-8">
              {[
                ...
                { req: "No excess packaging", detail: "Amazon penalises excessive packaging. Box dimensions must be appropriate for the product — no more than 2 inches of void fill on any side." },
              ].map((item, index) => (
            ...
            <div className="grid md:grid-cols-2 gap-4 mb-8">
              {[
                ...
                { label: "Shipping Label", detail: "Amazon generates shipping labels for FBA shipments. Print on white A4 paper, apply flat without wrinkles. Laser print only — inkjet may smear." },
            ...
            <div className="space-y-3 mb-8">
              {[
                { reason: "Product damaged in transit", pct: "Most common — usually due to insufficient cushioning or weak box" },
