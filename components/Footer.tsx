        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
          <div className="col-span-1 md:col-span-2">
            ...
            <div className="flex gap-5 mt-6">
              ...
              <a href="https://www.indiamart.com/company/270081127/" target="_blank" rel="noopener noreferrer" className="bg-white rounded-md p-0.5 hover:opacity-80 transition-opacity" aria-label="Find Packnivo on IndiaMART">
                <Image src="/indiamart-logo.png" alt="IndiaMART" width={20} height={20} className="w-5 h-5 object-contain" />
              </a>
            </div>
          </div>
