...
export const metadata: Metadata = {
  title: "Amazon India Packaging Requirements 2026 - Complete Seller Guide | Packnivo",
      ...
      <section style={{ backgroundColor: "#0C2448" }} className="py-16">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <h1 className="text-3xl md:text-5xl font-bold text-white mb-6 leading-tight" style={{ fontFamily: "Fraunces, serif" }}>
            Amazon India Packaging Requirements 2026 - Complete Seller Guide
          </h1>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="prose max-w-none">
            ...
            <div className="space-y-4 mb-8">
              {[
                { req: "Box strength - 3 ply minimum", detail: "All corrugated boxes must be minimum 3 ply (single wall). For products above 5kg, 5 ply (double wall) is recommended. Box must pass a 6-inch drop test." },
                ...
                { req: "No excess packaging", detail: "Amazon penalises excessive packaging. Box dimensions must be appropriate for the product with no more than 2 inches of void fill on any side." },
              ].map((item, index) => (
            ...
            <div className="grid md:grid-cols-2 gap-4 mb-8">
              {[
                ...
                { label: "Shipping Label", detail: "Amazon generates shipping labels for FBA shipments. Print on white A4 paper, apply flat without wrinkles. Laser print only as inkjet may smear." },
                ...
                { label: "Fragile and Handling Labels", detail: "Use internationally recognised handling labels for fragile, liquid or orientation-sensitive products." },
              ].map((item) => (
            ...
            <div className="space-y-3 mb-8">
              {[
                { reason: "Product damaged in transit", detail: "Most common - usually due to insufficient cushioning or weak box" },
                { reason: "Box too large for product", detail: "Amazon may charge for excess dimensional weight" },
                { reason: "Multiple barcodes on packaging", detail: "Causes scanning failures at fulfilment centres" },
                { reason: "Packaging not sealed properly", detail: "Open or damaged packaging on arrival leads to immediate return" },
                { reason: "Wrong product barcode", detail: "Mismatched barcodes cause inventory errors and returns" },
              ].map((item, index) => (
