        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-2xl">
            ...
            <p className="text-white/70 text-lg">
              Send us your packaging requirement and we will respond within 5 minutes during business hours.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-2 gap-12">
            ...
            <div className="bg-white rounded-2xl p-8 border border-gray-100">
              <h2 className="text-xl font-bold mb-6" style={{ color: "#0C2448", fontFamily: "Fraunces, serif" }}>
                Send us a message
              </h2>
              <div className="space-y-4">
                ...
                <button className="w-full py-3 rounded-xl font-semibold text-white text-sm transition-all hover:opacity-90" style={{ backgroundColor: "#C08430" }}>
                  Send Message
                </button>
                <p className="text-xs text-gray-400 text-center">
                  We respond within 5 minutes during business hours (Mon–Sat, 9AM–7PM IST)
                </p>
              </div>
            </div>
            ...
            <div className="space-y-6">
              <div className="bg-white rounded-2xl p-6 border border-gray-100">
                ...
                <div className="space-y-3 text-sm text-gray-600">
                  <div className="flex items-center gap-3">
                    ...
                    <span>info@packnivo.com</span>
                  </div>
                  <div className="flex items-center gap-3">
                    <span className="text-lg">📱</span>
                    <span>+91 83685 59892</span>
                  </div>
                  <div className="flex items-center gap-3">
                    <span className="text-lg">📍</span>
              ...
              <div className="bg-white rounded-2xl p-6 border border-gray-100">
                ...
                <p className="text-sm text-gray-600 mb-4">Find us on IndiaMART for verified business enquiries and bulk orders.</p>
                  ...
                  className="flex items-center justify-center gap-2 w-full py-3 rounded-xl font-semibold text-sm transition-all hover:opacity-90 border"
                  style={{ borderColor: "#0C2448", color: "#0C2448" }}
                >
                  View on IndiaMART
                </a>
              </div>
